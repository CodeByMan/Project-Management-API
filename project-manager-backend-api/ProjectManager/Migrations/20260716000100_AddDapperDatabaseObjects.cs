...
namespace ProjectManager.Migrations
{
    ...
    [Migration("20260716000100_AddDapperDatabaseObjects")]
    public partial class AddDapperDatabaseObjects : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.spGetProjects;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.spGetDashboardTasks;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.spGetProjectTasks;");
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS dbo.fnOverdueTasksCount;");
        }
    }
}
